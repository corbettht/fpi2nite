...
setup(
    name='fpi2nite',
    description="Quick utility to make a list of everything cool that happened on the night sky in the last week.",
    ...
    entry_points="""
    [console_scripts]
    fpi2nite=fpi2nite.cli:cli
    """,
    python_requires=">=0.0.1",
    license='GPLv3',  # noqa
    author='hank corbett',
    author_email='htc@unc.edu',
    # Use the URL to the github repo.
    url= 'https://github.com/corbettht/fpi2nite',
    download_url=(
        f'https://github.com/corbettht/'
        f'fpi2nite/archive/{version}.tar.gz'
    ),
    keywords=[
